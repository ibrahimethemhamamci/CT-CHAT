deepspeed --master_port 12540  llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints_new/vicuna_13B_ctclip-pretrain_256attention/mm_projector.bin \
    --image_aspect_ratio pad \
    --group_by_modality_length True \
    --bf16 True \
    --output_dir ./checkpoints_new/llava-vicuna_13B_ctclip-finetune_256-lora \
    --num_train_epochs 1 \
